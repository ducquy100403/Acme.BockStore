...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9bd2498d-56b2-4706-ab59-0d220b424170
```

> `9bd2498d-56b2-4706-ab59-0d220b424170` is the password of the certificate, you can change it to any password you want.
